package homework.homework11.medicalCenter.util;
...
public class DateUtil {
    ...
    public static boolean isSameDay(Date toDay, Date registerDateTime) {
        return SDF.format(toDay).equals(SDF.format(registerDateTime));
    }
}
